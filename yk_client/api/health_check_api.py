...
class HealthCheckApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __api_health_check_get(
            self,
            **kwargs
        ):
            """api_health_check_get  # noqa: E501
        ...
        self.api_health_check_get = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'Bearer'
                ...
                'operation_id': 'api_health_check_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__api_health_check_get
        )
